...
abstract class JModuleHelper
{
	...
	public static function renderModule($module, $attribs = array())
	{
		...
		// ClickFWD - made check of 'tp' param backwards compatible with older Joomla versions

		$tp_param = isset($app->input) ? $app->input->getBool('tp') : JRequest::getBool('tp');

		if ($tp_param && JComponentHelper::getParams('com_templates')->get('template_positions_display'))
		{
	...
	protected static function &load()
	{
		...
		$query = $db->getQuery(true)
			->select('m.id, m.title, m.published, m.module, m.position, m.content, m.showtitle, m.params, mm.menuid')
			->from('#__modules AS m')
