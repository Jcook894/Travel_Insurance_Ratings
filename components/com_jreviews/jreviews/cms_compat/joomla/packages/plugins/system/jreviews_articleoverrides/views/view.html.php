...
class ContentViewArticle extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		// Load JReviews template file

		$template_path = JPath::find($this->_path['template'], 'default_jreviews.php');

		$plugin_path = JPATH_SITE . '/plugins/system/jreviews_articleoverrides/templates/default_jreviews.php';
