...
JreviewsLocale::addStrings('php',
	...
	'RATINGS_RECALCULATED'				=>	__a("The rating ranks were successfully recalculated.",true),
	...
	'ACCESS_DENIED'             	=>	__a("You don't have enough access to perform this action.",true),
	...
	//  Updater
	'UPDATER_FAILED_ADDON_FOLDER'		=>	__a("Creating the addons folder failed. You need to manually create the addons folder.",true),
	'UPDATER_FAILED_ADDON_SUBFOLDERS'	=>	__a("It's not possible to create new addon folders. Please change permissions or ownership and try again.",true),
...
JreviewsLocale::addStrings('js',
	array(
		...
		'DB_ERROR'                  	=>	s2Messages::submitErrorDb(),
		'PROCESS_REQUEST_ERROR'			=>	s2Messages::submitErrorGeneric(),
		'MAKE_SELECTION_FROM_LIST'			=>	__a("Please make a selection from the list.",true),
		...
		'LISTING_TYPE_VALIDATE_CRITERIA'=>	__a("Please add a title for each one of the rating criteria.",true),
		...
		'FIELD_VALIDATE_NAME'       	=>  __a("The field doesn't exist",true),
		...
		'UPDATER_ADDON_INSTALLED'			=>	__a("The add-on was installed. If the add-on has a menu you will see it on the sidebar once you reload the page.",true),
		'UPDATER_ADDON_NOT_INSTALLED'		=>	__a("There was a problem installing the add-on.",true),
