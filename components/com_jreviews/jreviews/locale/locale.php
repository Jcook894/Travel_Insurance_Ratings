...
JreviewsLocale::addStrings('php',
	array(
		'ACCESS_DENIED'              			=>  __t("You don't have enough access to perform this action.",true),
		...
		'SEARCH_SELECT_LISTING_TYPE'			=>  __t("Select Listing Type",true),
		...
		'EMAIL_VALID'							=> 	__t("E-mail is valid",true),
		'EMAIL_INVALID'							=>	__t("E-mail is invalid",true),
		...
		'NOTIFY_NEW_REPORT'						=>	__t("A new %s report has been submitted",true),
		...
		'VALID_CAPTCHA'              			=>  __t("Please verify you are not a robot.",true),
		'VALID_CAPTCHA_INVALID'      			=>  __t("The security code you entered was invalid.",true),

		// These are never used directly, but are here so that they are automatically included in language files

		// listing general

		'LANG_LISTING_EDIT'						=> __t("LANG_LISTING_EDIT", true),
		'LANG_LISTING_FEATURED'					=> __t("LANG_LISTING_FEATURED", true),
		'LANG_LISTING_SEND_INQUIRY'				=> __t("LANG_LISTING_SEND_INQUIRY", true),

		// review general

		'LANG_REVIEW_WRITE_DETAIL'				=> __t("LANG_REVIEW_WRITE_DETAIL",true),
		'LANG_REVIEW_ADD_DETAIL'				=> __t("LANG_REVIEW_ADD_DETAIL",true),
		'LANG_REVIEW_ADD_COMMENT_DETAIL'		=> __t("LANG_REVIEW_ADD_COMMENT_DETAIL",true),
		'LANG_REVIEW_USER_REVIEWS_NOT_FOUND'	=> __t("LANG_REVIEW_USER_REVIEWS_NOT_FOUND",true),
		'LANG_REVIEW_USER_COMMENTS_NOT_FOUND'	=> __t("LANG_REVIEW_USER_COMMENTS_NOT_FOUND",true),

		// listing form

		'LANG_LISTING_CREATE'					=> 	__t("LANG_LISTING_CREATE", true),
		'LANG_LISTING_FORM_TITLE'				=> 	__t("LANG_LISTING_FORM_TITLE", true),
		'LANG_LISTING_FORM_TITLE_ALIAS'			=> 	__t("LANG_LISTING_FORM_TITLE_ALIAS", true),
		'LANG_LISTING_FORM_SUMMARY'				=> 	__t("LANG_LISTING_FORM_SUMMARY", true),
		'LANG_LISTING_FORM_DESCRIPTION'			=> 	__t("LANG_LISTING_FORM_DESCRIPTION", true),
		'LANG_LISTING_FORM_TITLE_SEARCH'		=> 	__t("LANG_LISTING_FORM_TITLE_SEARCH", true),
		'LANG_LISTING_FORM_UPLOAD_MEDIA_INFO'	=> 	__t("LANG_LISTING_FORM_UPLOAD_MEDIA_INFO", true),

		// media form

		'LANG_LISTING_MEDIA_UPLOAD_HEADER'		=> 	__t("LANG_LISTING_MEDIA_UPLOAD_HEADER", true),
		'LANG_REVIEW_MEDIA_UPLOAD_HEADER'		=> 	__t("LANG_REVIEW_MEDIA_UPLOAD_HEADER", true),
		'LANG_MEDIA_PHOTO_FUNCTION_GALLERY'		=> 	__t("LANG_MEDIA_PHOTO_FUNCTION_GALLERY", true),
		'LANG_MEDIA_PHOTO_FUNCTION_LOGO'		=> 	__t("LANG_MEDIA_PHOTO_FUNCTION_LOGO", true),
		'LANG_MEDIA_PHOTO_FUNCTION_COVER'		=> 	__t("LANG_MEDIA_PHOTO_FUNCTION_COVER", true),

		'FILTERS_CLEAR_ALL'			  			=> 	__t("FILTERS_CLEAR_ALL",true),
		)
);
...
JreviewsLocale::addStrings('js',
	array(
		...
		// Filters
		'FILTERS_MATCH_ALL'			  =>	__t("Narrow results matching all options", true),
		'FILTERS_RATINGS_AND_UP'	  => 	__t("FILTERS_RATINGS_AND_UP",true),
		'FILTERS_RANGE_DELIMITER'	  =>	__t("FILTERS_RANGE_DELIMITER",true),
		'FILTERS_CLEAR_SELECTED'	  =>	__t("FILTERS_CLEAR_SELECTED",true),
		'FILTERS_SHOW_ALL'	  		  =>	__t("FILTERS_SHOW_ALL",true),
		'FILTERS_SHOW_LESS'	  		  =>	__t("FILTERS_SHOW_LESS",true),
		'FILTERS_RANGE_MIN'	  		  =>	__t("FILTERS_RANGE_MIN",true),
		'FILTERS_RANGE_MAX'	  		  =>	__t("FILTERS_RANGE_MAX",true),
		)
);