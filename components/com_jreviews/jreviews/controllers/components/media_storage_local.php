...
class MediaStorageLocalComponent extends S2Component {
	...
	{
		return WWW_ROOT /* WWW_ROOT_REL */ . MEDIA_LOCAL_PATH . $this->getFolderName($media_type) . _DS . str_replace("\\","/",$object);
	}

	function getStoragePath($url)
	{
		// If it's a relative URL we convert it to an absolute url
