...
class OwnerRepliesController extends MyController
{
    ...
    var $helpers = array('routes','libraries','html','form');
    ...
    function beforeFilter()
    {
        ...
        $listing = $this->OwnerReply->query($query,'loadAssoc');
    ...
    function _save()
    {
        ...
        {
            if ($this->data['OwnerReply']['owner_reply_text'] != '' && $this->review_id > 0)
            {
                $this->data['OwnerReply']['id'] = $this->review_id;
