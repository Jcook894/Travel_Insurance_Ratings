...
class AdminInquiryController extends MyController
{
    ...
    function browse()
    {
        ...
        $queryData = array(
            ...
            'joins'=>array(
                'INNER JOIN ' . EverywhereComContentModel::_LISTING_TABLE . ' AS Listing on Listing.' . EverywhereComContentModel::_LISTING_ID . ' = Inquiry.listing_id'
               ),
            'order'=>array('Inquiry.created DESC')
             );
