...
class AdminTwitterController extends MyController
{
    ...
    function form()
    {
        ...
        $twitter_oauth = is_array($this->Config->twitter_oauth) ? $this->Config->twitter_oauth : json_decode($this->Config->twitter_oauth,true);
        ?>
        <p>For additional help read the <a target="_blank" href="https://docs.jreviews.com/?title=Setup_Twitter_integration">Twitter integration</a> article.</p>
