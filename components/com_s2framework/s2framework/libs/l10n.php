 ...
 */
	var $__l10nCatalog = array('af' => array('language' => 'Afrikaans', 'locale' => 'afr', 'localeFallback' => 'afr', 'charset' => 'utf-8'),
								...
								'sr-rs' => array('language' => 'Serbian', 'locale' => 'scc', 'localeFallback' => 'srp', 'charset' => 'utf-8'),
								'sr-yu' => array('language' => 'Serbian', 'locale' => 'src', 'localeFallback' => 'srp', 'charset' => 'utf-8'),								'sv' => array('language' => 'Swedish', 'locale' => 'swe', 'localeFallback' => 'swe', 'charset' => 'utf-8'),
 ...
 */
	function __setLanguage($language = null) {
		...
		if ($langKey !== null && isset($this->__l10nCatalog[$langKey])) {
			...
			// Mar 18, 2017 - Switched the order of fallback and default so that it's possible to override an existing language with country-specific versions
