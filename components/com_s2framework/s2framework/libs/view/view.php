...
/*		if (!empty($this->loaded)) {
	...
	function _render($___viewFn, $dataForView, $loadHelpers = true, $cached = false) {
		...
		$cache_enabled = Sanitize::getBool($cacheConf, 'view') || Sanitize::getBool($cacheConf,Inflector::camelize($this->name));
