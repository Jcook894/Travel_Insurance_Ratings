...
class Sanitize {
	...
	static function getString($var,$key,$default=null,$escape=false) {

		$out = (string) Sanitize::getVar($var,$key,$default);
 ...
 */
	static function stripScripts($str)
    {
        ...
        $filtered = htmLawed($str,array('safe'=>1));

        // Oct 13, 2016 - commented line below because it converts bad code into valid tags by converting entities to their normal characters
