...
// @modified: ClickFWD
require_once JPATH_BASE . '/components/com_menus/helpers/menus.php';
	...
	protected function preprocessForm(JForm $form, $data, $group = 'content')
	{
		...
		if ($type == 'component')
		{
			...
			if (isset($args['view']))
			{
				...
				JDispatcher::getInstance()->trigger('onAfterGetMenuFormViewPath', array(&$path, $option, $view, $this));
