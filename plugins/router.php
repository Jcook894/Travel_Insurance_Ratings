...
function ContentBuildRoute(&$query)
{
	...
	$advanced	= $params->get('sef_advanced_link', 0); //rustam code $advanced	= $params->get('sef_advanced_link', 0);
...
function ContentParseRoute($segments)
{
	...
	$item	= $menu->getActive();
	$params = JComponentHelper::getParams('com_content');
	 $advanced = $params->get('sef_advanced_link', 0); // rustam code
	$db = JFactory::getDBO();
