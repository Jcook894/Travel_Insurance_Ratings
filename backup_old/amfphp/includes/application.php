...
/**
 * @version		$Id: application.php 111 2008-05-04 15:56:48Z dynedain $
 * @package		J-AMFPHP
...
require_once('../libraries/joomla/application/application.php');

class JAMFPHP extends JApplication {
...
////			jimport( 'amfphp.core.shared.app.php5Executive' );
////			jimport( 'amfphp.core.shared.exception.php5Exception' );
////		}
////		else
////		{
////			//Cry
////			jimport( 'amfphp.core.shared.app.php4Executive' );
////			jimport( 'amfphp.core.shared.exception.php4Exception' );
////		}
////
