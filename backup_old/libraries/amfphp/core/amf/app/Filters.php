 ...
 * required files
 */
require_once(AMFPHP_BASE . 'amf' .DS. 'util' .DS. 'TraceHeader.php');
...
function deserializationFilter(&$amf) {
	...
	{
		include_once(AMFPHP_BASE . 'amf' .DS. 'io' .DS. 'AMFBaseDeserializer.php');
		include_once(AMFPHP_BASE . 'amf' .DS. 'io' .DS. 'AMFBaseSerializer.php');
		$deserializer = new AMFBaseDeserializer($amf->rawData); // deserialize the data
	}
	else
	{
		include_once(AMFPHP_BASE . 'amf' .DS. 'io' .DS. 'AMFDeserializer.php');
		include_once(AMFPHP_BASE . 'amf' .DS. 'io' .DS. 'AMFSerializer.php');
