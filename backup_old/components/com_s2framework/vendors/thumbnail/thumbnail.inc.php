...
class Thumbnail {
    ...
    function Thumbnail($fileName) {
    	...
    	if(!function_exists("gd_info")) {
        	echo 'You do not have the GD Library installed.  The thumbnail class requires the GD library to function properly.' . "\n";
...
//            break;
    ...
    function resize($maxWidth = 0, $maxHeight = 0) {
		...
		// Transparent background fix from http://www.gen-x-design.com/projects/php-thumbnailer-class/
		if( $this->format == 'PNG' ) {
